...
public class main {
    ...
    public static void main(String[] args) throws ParseException, IOException, SQLException {
        ...
        // 2C) Recuperar todos los estudiantes, y especificar alg̼n criterio de ordenamiento simple.
        ...
        // 2D) Recuperar un estudiante, en base a su n̼mero de libreta universitaria
        System.out.println("\n 2.D) Estudiante cuyo numero de libreta es 3:");
        System.out.println(studentRepo.getById(3));

        System.out.println("\n------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");

        // 2E) Recuperar todos los estudiantes, en base a su g̩nero.
